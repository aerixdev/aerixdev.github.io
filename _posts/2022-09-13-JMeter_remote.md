...
저희가 사용하고 있는 서버는 최대 800의 사용자가 동시에 접근하는 MQTT 접속을 처리할 수 있으며 TPS의 경우 1600~2800정도가 나온다는 것을 확인할 수 있었습니다. 또한 JMeter을 이용하여 구축한 시스템은 MQTT가 아닌 다른 프로토콜을 활용하더라도 측정이 가능하기 때문에 범용성이 높은 시스템을 구축할 수 있었습니다.
