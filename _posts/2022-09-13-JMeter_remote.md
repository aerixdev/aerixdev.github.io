...
저희가 사용하고 있는 서버가 800개의 MQTT 접속을 처리할 수 있으며 1600~2800 정도의 TPS가 나온다는 것을 확인할 수 있었습니다. 또한 JMeter을 통하여 시스템을 구축함으로써 MQTT가 아닌 다른 프로토콜을 사용하더라도 성능을 측정할 수 있는 시스템을 만들 수 있었습니다.
