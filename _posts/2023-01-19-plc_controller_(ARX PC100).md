...
# 제품 서비스 아키텍처
<img src="/img/posts/2023-01-19/system_architecture.png" alt="[피엘씨컨트롤러 시스템 구성]" width="50%">
...
<img src="/img/posts/2023-01-19/service_architecture.png" alt="[피엘씨컨트롤러 서비스 아키텍처]" width="50%">
...
- 로그인
    ...
    <img src="/img/posts/2023-01-19/login_page.png" alt="[관리자 웹 - 로그인 페이지]" width="50%">
...
- 대시보드
    ...
    <img src="/img/posts/2023-01-19/dashboard_page.png" alt="[관리자 웹 - 대시보드 페이지]" width="50%">
...
- PLC
    ...
    <img src="/img/posts/2023-01-19/plc_page.png" alt="[관리자 웹 - PLC 페이지]" width="50%">
...
- 프로토콜
    ...
    <img src="/img/posts/2023-01-19/protocol_page.png" alt="[관리자 웹 - 프로토콜 페이지]" width="50%">
...
- 설정
    ...
    <img src="/img/posts/2023-01-19/setting_page.png" alt="[관리자 웹 - 설정 페이지]" width="50%">
...
- 보안
    ...
    <img src="/img/posts/2023-01-19/security_page.png" alt="[관리자 웹 - 보안 페이지]" width="50%">
...
- 데이터 수집 및 전송
    - ‘디바이스 상태 , PLC 메모리 데이터’ 의 수집 정보를 수집 서버에 전송합니다.
        ...
        <img src="/img/posts/2023-01-19/data_collect.png" alt="[테스트 프로그램으로 확인한 수집 데이터 확인]" width="50%">
...
- 특정 PLC 메모리 데이터 조회
    - 설정한 PLC 의 특정 태그의 데이터를 조회한다.
        ...
        <img src="/img/posts/2023-01-19/data_read_request_1.png" alt="[테스트 프로그램으로 요청한 특정 메모리 데이터 확인]" width="50%">
...
- 특정 PLC 메모리 데이터 작성
    - 설정한 PLC 의 특정 태그의 데이터를 작성한다.
        ...
        1. 특정 태그의 메모리 데이터 변경
            ...
            <img src="/img/posts/2023-01-19/data_write_request.png" alt="[테스트 프로그램으로 요청한 특정 메모리 데이터 작성]" width="50%">
        ...
        1. 특정 태그의 메모리 데이터 변경 확인
            ...
            <img src="/img/posts/2023-01-19/data_read_request_2.png" alt="[테스트 프로그램으로 요청한 특정 메모리 데이터 확인]" width="50%">
            
            [테스트 프로그램으로 요청한 특정 메모리 데이터 확인]
            
            <img src="/img/posts/2023-01-19/plc_program_monitor.png" alt="[PLC 툴 프로그램으로 확인한 메모리 데이터 확인]" width="50%">
...
- 전송 실패 데이터 저장 ( 데이터 백업 )
    - 수집 서버에 연결 실패 혹은 다른 사유에 의한 전송 실패 시 해당 데이터가 누락되지 않게 저장을 하여 재 전송을 할 수 있도록 데이터를 백업합니다.
        ...
        <img src="/img/posts/2023-01-19/back_up_db.png" alt="[저장된 수집 데이터 확인]" width="50%">
...
[추후 업데이트 예정입니다.. ㅠ (연휴 이후 시험 성적서 및 인증서 발급 가능..)]

(GS 인증) - 자체 개발 ‘피엘씨컨트롤러’로 소프트웨어 품질 인증 GS 인증 획득 [한국정보통신기술협회 - 23.01.xx]
...
- 제품
    - ARX.PC100 [하드웨어 : 산업용 PC , 소프트웨어 : 피엘씨컨트롤러]
        ...
        <img src="/img/posts/2023-01-19/plc_controller_front.png" alt="[ARX.PC100 제품 이미지 - 앞면]" width="50%">
        
        [ARX.PC100 제품 이미지 - 앞면]
        
        <img src="/img/posts/2023-01-19/plc_controller_back.png" alt="[ARX.PC100 제품 이미지 - 뒷면]" width="50%">
